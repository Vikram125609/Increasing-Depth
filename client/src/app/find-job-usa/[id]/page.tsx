...
export const generateMetadata = async ({
  ...
  const title: string = await new Promise((resolve) =>
    setTimeout(() => resolve(`Find Jobs USA ${params.id}`), 1000)
  );
  return {
    title: title,
